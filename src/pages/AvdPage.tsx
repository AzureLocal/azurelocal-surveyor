...
export default function AvdPage() {
  const { avdEnabled, setAvdEnabled } = useSurveyorStore()
  return (
    <div className="space-y-8">
      ...
      <label className="panel flex items-center gap-3"><input type="checkbox" checked={avdEnabled} onChange={e => setAvdEnabled(e.target.checked)} />Include AVD in workload demand</label>
      <AvdPlanner />
    </div>
  )
}
