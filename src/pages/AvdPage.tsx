    ...
    <div className="space-y-8">
      ...
      <div className="rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 p-4 text-sm space-y-2">
        <p className="text-gray-700 dark:text-gray-300">
          ...
          desktops and RemoteApp published applications from one or more host pools running on your Azure Local cluster.
        ...
        <p className="text-xs text-gray-500">
          Surveyor now models multiple host pools natively. Use separate pools when workload type, session
          model, user counts, or FSLogix storage location differ. Aggregate results show the total Azure Local
          compute footprint, while profile storage hosted in SOFS, Azure Files, or external SMB is tracked separately.
        </p>
        <p className="text-xs text-gray-500">
